...
local entities = require("../entities.lua")
...
local utf8_lower do
  if pcall(require, "utf8") then -- try luautf8
    local luautf8 = require("utf8")
...
function M.new(writer, options)
  ...
  if options.alter_syntax and typ(options.alter_syntax) == "function" then
